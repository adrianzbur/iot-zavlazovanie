...
function runAutomation() {
  ...
  if (shouldPump && !a.pump) {
    ...
    console.log("Pumpa ZAP — poda: " + s.soilMoisture + "% < prah: " + auto.irrigation.threshold + "%");
    ...
    pumpTimer = setTimeout(() => {
      ...
      broadcast("actuators", state.actuators);
      console.log("Pumpa VYP — uplynulo " + auto.irrigation.duration + "s (ochrana)");
      pumpTimer = null;
    ...
    broadcast("actuators", state.actuators);
    console.log("Pumpa VYP — poda dostatocne vlhka: " + s.soilMoisture + "%");
  }
}
      ...
      <div style={{
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <div>
              <div style={{ fontSize: 16, fontWeight: 800, letterSpacing: 1, color: S.cyan }}>SMART GREENHOUSE</div>
              <div style={{ fontSize: 10, color: S.textMuted, letterSpacing: 2, marginTop: 1 }}>
                IoT CONTROL SYSTEM · ESP32 · DHT11
              </div>
            </div>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
